...
function sp_get_acf_key( $field_name ) {
	...
	switch( $field_name ) {
		...
		case 'sp_fname':
			$field_key = 'field_55c8ec63416a2';  // USE ACTUAL VALUE!!!
			break;
		case 'sp_lname':
			$field_key = 'field_55c8ec76416a3';  // USE ACTUAL VALUE!!!
			break;
		case 'sp_email':
			$field_key = 'field_55c8ec87416a4';  // USE ACTUAL VALUE!!!
			break;
		case 'sp_subscriptions':
			$field_key = 'field_55c8ecac416a5';  // USE ACTUAL VALUE!!!
			break;
